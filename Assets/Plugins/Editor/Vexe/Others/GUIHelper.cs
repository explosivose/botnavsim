...
namespace Vexe.Editor.Helpers
{
	public static class GUIHelper
	{
		...
		// Reflection
		#region
		private static MethodInvoker  toolbarSearchField_GL;
		public static MethodInvoker ToolbarSearchField_GL
		{
			get
			{
		...
		private static MethodInvoker  toolbarSearchField;
		public static MethodInvoker ToolbarSearchField
		{
			get
			{
